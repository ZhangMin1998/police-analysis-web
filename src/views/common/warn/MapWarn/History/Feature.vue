...
const columns = [
  ...
  { label: '预警类型', prop: 'attrTypeName', minWidth: '10%' },
  { label: '预警号码', prop: 'attrValue', minWidth: '10%' },
  {
    label: '警报级别',
    prop: 'warningLevel',
    minWidth: '8%',
  ...
  { label: '预警场所', prop: 'placeName', minWidth: '10%' },
  { label: '场所地址', prop: 'placeAddress', minWidth: '16%' },
  {
    label: '经纬度',
