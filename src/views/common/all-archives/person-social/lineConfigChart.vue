        ...
        <div class="basic_set">
          ...
          <div class="form">
            <div class="formRow">
              ...
              <div class="input_box">
                <el-input v-model.trim="lineChartStyle.titleStyle.text" placeholder="图表名称"></el-input>
              </div>
            </div>
            <div class="formRow">
  ...
  methods: {
    ...
    xMinChange () {
      if (!this.option.form.xMin) {
        this.lineChartStyle.xAxisStyle.min = null
      } else {
        this.lineChartStyle.xAxisStyle.min = this.option.form.xMin
      }
    },
    xMaxChange () {
      if (!this.option.form.xMax) {
        this.lineChartStyle.xAxisStyle.max = null
      } else {
        this.lineChartStyle.xAxisStyle.max = this.option.form.xMax
      }
    },
    yMinChange () {
      if (!this.option.form.yMin) {
        this.lineChartStyle.yAxisStyle.min = null
      } else {
        this.lineChartStyle.yAxisStyle.min = this.option.form.yMin
      }
    },
    yMaxChange () {
      if (!this.option.form.yMax) {
        this.lineChartStyle.yAxisStyle.max = null
      } else {
        this.lineChartStyle.yAxisStyle.max = this.option.form.yMax
      }
    },
  }
}
