<template>
  <div class="Relation">
      ...
      <PageHeader :cusStyle="{ margin: 0 }">
        <template>
          ...
          <div @click="$router.go(-1)">
            <!-- <nav-title :title="routerName"></nav-title> -->
    ...
    <el-container class="Relation-elContainer" v-loading="isLoading"
    element-loading-background="rgba(36, 47, 70, .5)"
    ...
    element-loading-spinner="el-icon-loading">
      ...
      <el-aside width="500px" v-if="!isShow">
        ...
        <el-container class="Relation-form" v-else>
          <el-header class="Relation-form-elHeader">
            <CusTitle title="修改关系" :curStyle="{ 'margin-bottom': '0' }"></CusTitle>
          </el-header>
          <el-main class="Relation-form-elMain">
            <div class="Relation-form-elMain-form">
              ...
              <div class="Relation-form-elMain-form-row">
                ...
                <el-col class="Relation-form-elMain-form-row-rightArrow" :span="7" :offset="1">
                  <img
...
import { findRelation, deleteAttrs, deleteShip } from '@/api/allArchives'
...
export default {
  ...
  methods: {
    ...
    NodeChange (canvas) {
      this.isLoading = true
      this.RelationId = canvas || this.RelationId
      findRelation(this.RelationId).then(res => {
        ...
        const list = res.nodes.map(_c => {
          return {
            ...
            label: _c.name || _c.index || _c.typeValue || _c.imei || _c.imsi,
            value: _c.id,
