<template>
  <div class="TrailTable">
    ...
    <div class="main_box">
      <Loading :isLoading.sync="loading">
        <div v-if="!isEmpty">
          <template-table
            ...
            :header-cell-style="
              () =>
                'background-color: rgba(255, 255, 255, .04) !important;color:#8799BF;font-size:16px;font-weight:400'
            "
            :newRowColor="true"
...
import { getPersonTrack } from '@/api/allArchives'
...
export default {
  ...
  methods: {
    ...
    openDetail (row) {
      console.log(row)
      this.rightDialogInfo.type = row.dataTypeStr
