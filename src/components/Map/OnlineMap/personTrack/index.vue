  ...
  methods: {
    ...
    generateMarker (item, cls) {
      ...
      const overlay = new AMap.Marker({
        ...
        position: location,
        content: `<div class='${cls} icon-cicle-marker'"></div>`,
        extData: {
          ...item
        }
      })
...
.defaultMark {
  ...
  // height: 34px;
  // line-height: 34px;
  background: url(~img/tack-default.png);
}
.activeMark {
  // width: 34px;
  // height: 34px;
  // line-height: 34px;
  background: url(~img/track-active.png);
}
.clickpop-h {
  margin-top: 0;
  margin-bottom: 6px;
...
// .start {
//   background: url(~img/car-start.png);
// }
// .by {
//   background: url(~img/car-by.png);
// }
// .end {
//   background: url(~img/car-end.png);
// }
// .startAndEnd {
//   background: url(~img/car-start-with-end.png);
// }
// .activeStart {
//   width: 34px;
//   height: 34px;
//   line-height: 34px;
//   background: url(~img/car-active-start.png);
// }
// .activeEnd {
//   width: 34px;
//   height: 34px;
//   line-height: 34px;
//   background: url(~img/car-active-end.png);
// }
// .activeStartAndEnd {
//   width: 34px;
//   height: 34px;
//   line-height: 34px;
//   background: url(~img/car-active-startandend.png);
// }
</style>
