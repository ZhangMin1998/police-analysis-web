...
export default {
  ...
  computed: {
    ...
    clsName () {
      return this.roomData.isActive ? 'icon-tab-room-active' : 'icon-tab-room-normal'
    },
  },
  watch: {
  ...
  methods: {
    ...
    createMaker () {
      ...
      this.isRoom ? this.addRoomMarkers(this.overlay) : this.addDeviceMarkers(this.overlay)
    },
    clickMarker () {
