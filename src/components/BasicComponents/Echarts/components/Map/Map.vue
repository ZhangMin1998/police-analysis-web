...
<script>
import OlView from '@/commons/map/View.vue'
import uuid from 'uuid/v4'

import BaseLayer from '@/commons/map/layer/baseLayer'
import MapSearch from '@/commons/map/map-search'
...
export default {
  ...
  methods: {
    ...
    initMap () {
      ...
      this.$store.state.Ol.oMap = this.map = new ol.Map({
